...
class alignas(32) RXBitBoard {
    ...
    static unsigned long long do_flips_NEON(const int pos, const unsigned long long P, const unsigned long long O);
    static unsigned long long do_flips_NEON(const int pos1, const int pos2, const unsigned long long P, const unsigned long long O, unsigned long long& res2);
    ...
    static unsigned long long do_flips_AVX2(const int pos1, const int pos2, const unsigned long long P, const unsigned long long O, unsigned long long& res2);
    ...
    static inline unsigned long long do_flips(const int pos1, const int pos2, const unsigned long long P, const unsigned long long O, unsigned long long& flipped_2);
    ...
    //    static unsigned long long calc_legal(const unsigned long long P, const unsigned long long O);
    ...
    static int count_potential_moves(const unsigned long long P, const unsigned long long O);
    static void dual_potential_mobility(const unsigned long long P, const unsigned long long O, int &p_pmob, int &o_pmob);
...
RX_ALWAYS_INLINE RXBitBoard& RXBitBoard::operator=(const RXBitBoard& src) {
    ...
    RXSquareList* RX_RESTRICT current_dest_base = this->empties_list;
...
inline void RXBitBoard::moves_producing(RXMove* start, unsigned long long exclude_mask) const {
    ...
    unsigned long long legal_moves = get_legal_moves(discs[player], discs[player^1]);
    legal_moves &= ~exclude_mask;
...
RX_ALWAYS_INLINE unsigned long long RXBitBoard::hashcode() const {
    return RXBitBoard::hashcode(this->discs[this->player], this->discs[this->player^1]);
}

RX_ALWAYS_INLINE unsigned long long RXBitBoard::hashcode(const unsigned long long P, const unsigned long long O) {
...
RX_ALWAYS_INLINE void RXBitBoard::do_move(const RXMove& move) {
...
RX_ALWAYS_INLINE void RXBitBoard::undo_move(const RXMove& move) {
...
RX_ALWAYS_INLINE void RXBitBoard::do_pass() {
    player ^= 1;
}
 ...
 */
inline int RXBitBoard::get_mobility(const unsigned long long P, const unsigned long long O) {
    
    const unsigned long long legals = get_legal_moves(P, O);
    return std::popcount(legals)  +  std::popcount(legals & 0x8100000000000081ULL);
 ...
 *
 */
RX_ALWAYS_INLINE unsigned long long RXBitBoard::get_stable_edge(const unsigned long long P, const unsigned long long O) {
    
    auto packA1A8 = [] RX_LAMBDA_INLINE (const unsigned long long x) noexcept {
        return ((x & 0x0101010101010101ULL) * 0x0102040810204080ULL) >> 56;
    };
    
    auto packH1H8 = [] RX_LAMBDA_INLINE (const unsigned long long x) noexcept {
        return ((x & 0x8080808080808080ULL) * 0x0002040810204081ULL) >> 56;
    };
    
    auto unpackA2A7 = []RX_LAMBDA_INLINE (const unsigned long long x) noexcept {
        return ((x & 0x7eULL) * 0x0000040810204080ULL) & 0x0001010101010100ULL;
    };
    
    auto unpackH2H7 = []RX_LAMBDA_INLINE (const unsigned long long x) noexcept {
...
RX_ALWAYS_INLINE int RXBitBoard::get_edge_stability(const unsigned long long P, const unsigned long long O) {
    return std::popcount(RXBitBoard::get_stable_edge(P, O));
}


RX_ALWAYS_INLINE int RXBitBoard::get_corner_stability(const unsigned long long& discs_player) {
...
//    stables |= (discs_player & (stables >> 8)) & 0x0081000000000000ULL;
    ...
    const  unsigned long long stables = ((((  0x0100000000000001ULL & discs_player) << 1) | ((0x8000000000000080ULL & discs_player) >> 1)
                                          | ((0x0000000000000081ULL & discs_player) << 8) | ((0x8100000000000000ULL & discs_player) >> 8)
                                          |  0x8100000000000081ULL) & discs_player);

    
    return std::popcount(stables);
    
}

RX_ALWAYS_INLINE int RXBitBoard::count_potential_moves(const unsigned long long P, const unsigned long long O) {

    const unsigned long long inner_opp_7E = O & 0x7E7E7E7E7E7E7E7EULL;
    const unsigned long long inner_opp_FF = O & 0x00FFFFFFFFFFFF00ULL;

    unsigned long long
    pot_moves = (inner_opp_7E << 1 | inner_opp_7E >> 1) | (inner_opp_FF << 8 | inner_opp_FF >> 8);

    const unsigned long long inner_opp = O & 0x007E7E7E7E7E7E00ULL;
    pot_moves |= (inner_opp << 7 | inner_opp >> 7) | (inner_opp << 9 | inner_opp >> 9);
    
    pot_moves &= ~(P|O);
    
    return std::popcount(pot_moves);

}


inline int RXBitBoard::final_score_1 () const {
    int score = 63-2*std::popcount(discs[player^1]);
...
inline int RXBitBoard::final_score_2(const unsigned long long discs_player, const unsigned long long discs_opponent, const int alpha, const int beta, const int idSquare1, const int idSquare2) const {
    ...
    if((discs_opponent & NEIGHBOR[idSquare1]) && (flipped_1 = do_flips(idSquare1, discs_player, discs_opponent))) {
        ...
        bestscore = 62 - 2*std::popcount(next_P);
    ...
    if((discs_opponent & NEIGHBOR[idSquare2]) && (flipped_1 = do_flips(idSquare2, discs_player, discs_opponent))) {
        ...
        int score = 62 - 2*std::popcount(next_P);
    ...
    if(bestscore == UNDEF_SCORE) {
        ...
        unsigned long long flipped_2 = 0;
        flipped_1 = do_flips(idSquare1, idSquare2, discs_opponent, discs_player, flipped_2);
        ...
        if(flipped_1) {
            ...
            bestscore = 62 - 2*std::popcount(next_O);
        ...
        if(flipped_2) {
            ...
            int score = 62 - 2*std::popcount(next_O);
        ...
        if(bestscore == UNDEF_SCORE) {
            ...
            bestscore = 62 - 2*std::popcount(discs_player);
            if(bestscore>0)
                bestscore+=2;
            else if (bestscore<0)
                bestscore-=2;
...
inline int RXBitBoard::final_score_3(const unsigned long long discs_player, const unsigned long long discs_opponent, int alpha, int beta, const unsigned int shuf3, const unsigned int empties3) const {
    ...
    if (bestscore == UNDEF_SCORE) {
        ...
        if(bestscore == UNDEF_SCORE) {
            bestscore = 61-2*std::popcount(discs_player);
            if(bestscore>0)
                bestscore+=3;
            else
                bestscore-=3;
...
inline int RXBitBoard::final_score_4(const unsigned long long discs_player, const unsigned long long discs_opponent, int alpha, int beta, const bool passed, const unsigned int shuf4, const unsigned int empties4) const {
    ...
    const int idSquare1 = (empties4 >> ((shuf4 >> (6 - 3)) & 0x18)) & 0xFF;
    if ((discs_opponent & NEIGHBOR[idSquare1]) && (flipped = do_flips(idSquare1, discs_player, discs_opponent))) {
    ...
    const int idSquare2 = (empties4 >> ((shuf4 >> (14 - 3)) & 0x18)) & 0xFF;
    if ((discs_opponent & NEIGHBOR[idSquare2]) && (flipped = do_flips( idSquare2, discs_player, discs_opponent))) {
    ...
    const int idSquare3 = (empties4 >> ((shuf4 >> (22 - 3)) & 0x18)) & 0xFF;
    if ((discs_opponent & NEIGHBOR[idSquare3]) && (flipped = do_flips( idSquare3, discs_player, discs_opponent))) {
    ...
    const int idSquare4 = (empties4 >> ((shuf4 >> 30) * 8)) & 0xFF;
    ...
    if(bestscore == UNDEF_SCORE) {
        ...
        if (passed) {
            bestscore = 60-2*std::popcount(discs_opponent);
            if(bestscore>0)
                bestscore+=4;
            else if (bestscore<0)
                bestscore-=4;
            ...
            int diff_discs = 60 - 2*std::popcount(discs_opponent);
